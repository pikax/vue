...
const builds = {
  ...
  'web-compiler': {
    ...
    format: 'cjs',
    exports: 'auto',
    external: getExternal(require('../packages/vue-template-compiler/package.json'))
  },
  ...
  'web-server-renderer-dev': {
    ...
    exports: 'auto',
    env: 'development',
    external: getExternal(require('../packages/vue-server-renderer/package.json'))
  },
  ...
  'weex-compiler': {
    ...
    format: 'cjs',
    exports: 'auto',
    external: getExternal(require('../packages/weex-template-compiler/package.json'))
  }
}
...
function genConfig (name) {
  ...
  const entries = Object.assign({}, aliases, opts.alias)
